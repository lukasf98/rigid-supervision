# This is a modification of https://github.com/junyuchen245/TransMorph_Transformer_for_Medical_Image_Registration/blob/c8eb40797274747c3b0b5854ab85444b3d7710f1/OASIS/TransMorph/models/TransMorph.py
'''
TransMorph model
...
class SpatialTransformer(nn.Module):
    ...
    def forward(self, src, flow):
        ...
        return nnf.grid_sample(src, new_locs, align_corners=False, mode=self.mode), new_locs
...
class TransMorph(nn.Module):
    ...
    def forward(self, x, moving):
        ...
        out, flow_grid_smaple = self.spatial_trans(moving, flow)
        return out, flow, flow_grid_smaple#, out_feats
